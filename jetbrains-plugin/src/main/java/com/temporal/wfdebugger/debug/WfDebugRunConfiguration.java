...
public class WfDebugRunConfiguration extends RunConfigurationBase<WfDebugRunState> {
    ...
    protected WfDebugRunConfiguration(@NotNull Project project, @NotNull ConfigurationFactory factory, @NotNull String name) {
    ...
    private boolean isWfDebuggerProject(File dir) {
        return new File(dir, "Makefile").exists() && 
               new File(dir, "delve_wrapper").exists() && 
    ...
    public void checkConfiguration() throws RuntimeConfigurationException {
        ...
        if (!findWfDebuggerRoot(workingDir)) {
            throw new RuntimeConfigurationWarning(
                "Could not find wf-debugger project structure (Makefile, delve_wrapper, my-wf) " +
